...
try:  # SB3 only needed for the VecEnv wrapper / features-extractor classes
    from stable_baselines3.common.torch_layers import BaseFeaturesExtractor
    from stable_baselines3.common.vec_env import VecEnvWrapper
    _HAS_SB3 = True
except ImportError:  # classes below stay importable but unusable without SB3
...
# ---------------------------------------------------------------------------
# Fast path (plain gymnasium): frozen encoder as an ObservationWrapper
# ---------------------------------------------------------------------------

class FrozenEncoderWrapper(gym.ObservationWrapper):
    """
    Frozen-PVR fast path for explicit training loops (train_sac.py):
    ...
    Backed by src/embeddings.py's EmbeddingNet (same as train_bc.py and
    PVRFeaturesExtractor): a new PVR checkpoint needs a new
    configs/embedding/<name>.yaml, not new code here.
    """
    ...
    def observation(self, obs: np.ndarray) -> np.ndarray:
        ...
        # layout/dtype PVRFeaturesExtractor feeds EmbeddingNet.encode
...
# ---------------------------------------------------------------------------
# Fast path (SB3): frozen encoder as a VecEnv wrapper
# ---------------------------------------------------------------------------
